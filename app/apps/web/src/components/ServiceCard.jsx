    ...
    >
      <Card className="h-full border-gray-200 hover:border-primary hover:shadow-xl transition-all duration-300 overflow-hidden group">
        <CardContent className="p-8 flex flex-col h-full bg-white">
          ...
          <button className="mt-8 flex items-center gap-2 text-primary font-semibold hover:gap-3 transition-all duration-300">
            Learn more about {title.split(' ')[0]} <ArrowRight className="w-4 h-4" />
          </button>
        </CardContent>
      </Card>
    </motion.div>
