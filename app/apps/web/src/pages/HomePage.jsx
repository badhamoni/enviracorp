...
import { ShieldCheck, Zap, Globe, CheckCircle2, Cloud, Code, Brain, Settings, Briefcase, Stethoscope, Landmark, ShoppingCart, Factory, HeartPulse, GraduationCap, Smartphone, Network, Database, Server, Cpu, Layers, GitMerge, FileCode, Package, LayoutGrid } from 'lucide-react';
      ...
      <main>
        ...
        <section id="home" className="relative min-h-dvh flex items-center pt-20 overflow-hidden bg-[#07142D]">
          ...
          <div className="absolute inset-0 z-0">
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_left,_rgba(14,166,255,0.18),_transparent_28%),radial-gradient(circle_at_top_right,_rgba(13,148,255,0.14),_transparent_24%),linear-gradient(180deg,#07142D_0%,#020816_100%)]" />
            <div className="absolute inset-0 bg-gradient-to-b from-[#07142D]/70 via-[#07142D]/86 to-[#07142D]" />
          </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              duration: 0.8
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <Button onClick={() => scrollTo('#cta')} size="lg" className="bg-primary hover:bg-primary/90 text-white font-bold h-14 px-8 rounded-xl text-base shadow-[0_0_20px_rgba(0,102,255,0.3)]">
                    Request Technical Audit
                  </Button>
                  <Button onClick={() => scrollTo('#services')} size="lg" variant="outline" className="h-14 px-8 rounded-xl border-white/20 text-white hover:bg-white hover:text-[#07142D] font-bold text-base bg-transparent">
                    Explore Services
                  </Button>
                </div>
              </motion.div>
        ...
        {/* FEATURE HIGHLIGHTS */}
        <section className="relative -mt-20 z-20 pb-20 bg-[#07142D]">
        ...
        <section id="services" className="py-24 bg-gray-50 text-gray-900">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              <h2 className="text-gray-900 mb-6">End-to-End Technology Services to Accelerate Your Business</h2>
        ...
        <section id="industries" className="py-24 bg-[#0A1935] relative">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
              ...
              <Button variant="outline" className="border-white/20 text-white hover:bg-white hover:text-navy">
                View Case Studies
              </Button>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {industries.map((ind, idx) => <IndustryCard key={idx} {...ind} delay={idx * 0.1} />)}
            </div>
          </div>
        </section>
        ...
        <section id="cta" className="py-24 bg-[#07142D] relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            duration: 0.6
          }} className="max-w-4xl mx-auto text-center glass rounded-3xl p-10 md:p-16 border border-white/20">
              <h2 className="text-white mb-6 text-4xl md:text-5xl">
                Ready to Accelerate Your Digital Transformation?
              </h2>
              <p className="text-xl text-gray-300 mb-10 max-w-2xl mx-auto">
                Partner with Enriva to build robust, scalable technology solutions that drive real business impact. Let's discuss your next big initiative.
              </p>
              <Button size="lg" className="bg-primary hover:bg-white hover:text-primary text-white font-bold h-16 px-10 rounded-xl text-lg shadow-[0_0_30px_rgba(0,102,255,0.4)] transition-all duration-300">
